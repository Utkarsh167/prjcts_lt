...
const VALIDATION_MESSAGE = {
	...
	companyId: {
		...
		pattern: "Please enter a valid company id."
	}
};
...
const EMAIL_TEMPLATE = {
	...
	SUBJECT: {
		...
		EXPIRED_FLEET_LICENCE: "Expired Commutev licence",
	},
	BCC_MAIL: ["pramod.jaiswal@appinventiv.com"],
	FROM_MAIL: "donot-reply@commutev.com"
};
...
const NOTIFICATION_TYPE = {
	...
	TRIP_RESCHEDULE_BY_ADMIN: 7,
	TRIP_CANCEL_BY_ADMIN: 8,
};
const NOTIFICATION_MESSAGE = {
	...
	SOS_RESOLVED_BY_ADMIN: 'Your SOS request closed by admin.',
	CANCELLED_RIDE: "Employee cancelled ride.",
	TRIP_RESCHEDULE_BY_ADMIN: "Trip reschedule approved by admin.",
	TRIP_CANCEL_BY_ADMIN: "Rour reschedule trip request cancel by admin",
};
...
const NOTIFICATION_TITLE = {
	...
	TRIP_RESCHEDULE_BY_ADMIN: "Trip reschedule",
	TRIP_CANCEL_BY_ADMIN: "Trip cancelled",
};
...
const DEEPLINK = {
	...
	ANDROID_DRIVER_PACKAGE_NAME: 'com.fleetmanagement.driver',
	ANDROID_EMP_PACKAGE_NAME: 'com.fleetmanagement.employee',
