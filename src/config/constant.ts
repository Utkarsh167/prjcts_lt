...
const MODULE_NAME = {
	...
	EMPLOYEE_VEHICLE: "Employee Vehicle Management",
	CAB: "Cab Management",
...
const MODULE_KEY = {
	...
	DASHBOARD: "dashboard",
	ENTRY_LOG: "entryLog",
	// Added Employee Vehicle Management Aashiq - 24/08/2020
	EMPLOYEE_VEHICLE_MANAGEMENT: "emp_vehicle",
	PROFILE: "profile",
	REAL_TIME_DURATION: "realTimeDuration",
	// EMPLOYEE: "Dashboard",
	VEHICLE: "vehicle",
	GUARD: "guard",
	// NOTIFICATION: "notification",
...
const VALIDATION_MESSAGE = {
	...
	regNo: {
		...
		pattern: "Please enter a valid registration number."
	},
	password: {
	...
	vehicleId: {
		...
		pattern: "Please enter a valid vehicle id."
	},
	driverId: {
...
const EMAIL_TEMPLATE = {
	...
	SUBJECT: {
		...
		WECOME_GLIDAR: "Welcome to AI Parking!",
		SIGNUP_PWD_EMAIL: "Login Credential",
	},
	BCC_MAIL: ["utkarsh.patil@translabinnovations.com"],
	FROM_MAIL: "donotreply@translabinnovations.com" // "do-not-reply@mail.appinventive.com"
};
...
const REGEX = {
	...
	STRING_REPLACE: /[-+ ()*_$#@!{}|\/^%`~=?,.<>:;'"]/g,
	MONGO_ID: /^[a-f\d]{24}$/i,
	// REGNO: /(([A-Za-z]){2,3}(?:[0-9]){1,2}(?:[A-Za-z]){2}([0-9]){1,4})|(([A-Za-z]){2,3}([0-9]){1,4})$/i
...
const PARQUERY_URL = 'https://showcase-alpha.io.parquery.com/dashboard/api/';

const ANPR_CAMERA_OPEN_URL = 'http://192.168.0.190/cgi-bin/paramManager.cgi?action=setParam&Alarm[0].SensorType.AlarmOutEnable=NC';

const ANPR_CAMERA_CLOSE_URL = 'http://192.168.0.190/cgi-bin/paramManager.cgi?action=setParam&Alarm[0].SensorType.AlarmOutEnable=NO';

const PARQUERY_ENDPOINTS = {
	SCOPE: 'scope',
	HISTORICAL_RANGE: 'historical/range',
	HISTORICAL_AGGREGATE: 'historical/aggregate',
	TIME_TRACK_RANGE: 'time_track/range',
	TIME_TRACK_SNAPSHOT: 'time_track/snapshot',
	TIME_TRACK_OCCUPIERS: 'time_track/occupiers',
	TIME_TRACK_VACANTS: 'time_track/vacants',
	TIME_TRACK_VIDEO_FROM_FORM: 'time_track/video_from_form',
	PLAIN_IMAGE: 'plan_image?id=cotesa'
	};

const AUTH_DATA_PARQURY = {
	user: 'showcase',
	pass: 'audience-another-as-forth',
	sendImmediately: false
  };

  const AUTH_DATA_ANPR = {
	user: 'admin',
	pass: '123456',
	sendImmediately: false
  };
...
export const CONSTANT = Object.freeze({
	...
	CUT_OFF_TIME,
	PARQUERY_URL,
	ANPR_CAMERA_OPEN_URL,
	ANPR_CAMERA_CLOSE_URL,
	AUTH_DATA_ANPR,
	PARQUERY_ENDPOINTS,
	AUTH_DATA_PARQURY,
	ENTRY_LOG
