...
let adminNotificationSchema = new Schema({
	...
	// Company Id and Created Added Aashiq - 18/08/2020
	companyId: { type: mongoose.Schema.Types.ObjectId, ref: 'company_details' },
	created: { type: Number, default: Date.now() },
	longDuration: { type: Boolean, default: false }, // Added longDuration - Shivakumar A
	status: {
		type: String,
		enum: [
