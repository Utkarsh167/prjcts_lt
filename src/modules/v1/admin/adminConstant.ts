...
export const MESSAGES = {
	ERROR: {
		...
		NUMBER_ONLY_ALLOWED: {
			"statusCode": config.CONSTANT.HTTP_STATUS_CODE.BAD_REQUEST,
			"message": "Settings should contain only number",
			"type": "NUMBER_ALLOWED"
		},
	...
	SUCCESS: {
		...
		ADMIN_SETTINGS: (data) => {
			return {
				"statusCode": config.CONSTANT.HTTP_STATUS_CODE.OK,
				"message": "Admin settings get successfully.",
				"type": "ADMIN_SETTINGS",
				"data": data
			};
		},
		UPDATE_ADMIN_SETTINGS: (data) => {
			return {
				"statusCode": config.CONSTANT.HTTP_STATUS_CODE.OK,
		...
		ADMIN_LOCATIONS: (data) => {
			return {
				"statusCode": config.CONSTANT.HTTP_STATUS_CODE.OK,
				"message": "Building Locations fetched successfully.",
		...
		USER_FLOORS: (data) => {
			return {
				"statusCode": config.CONSTANT.HTTP_STATUS_CODE.OK,
				"message": "Building floors fetched successfully.",
				"type": "USER_FLOORS",
				"data": data
			};
		},
