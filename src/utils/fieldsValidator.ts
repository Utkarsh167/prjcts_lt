...
let registrationNo = Joi.string().allow("").required().label("Cab registration nos");
...
let drunker = Joi.number().required().valid([
...
let houseNo = Joi.string().optional().description("Home no");
let roadName = Joi.string().optional().description("Home roadName");
let city = Joi.string().optional().description("Home city");
let state = Joi.string().optional().description("Home state");
let landMark = Joi.string().optional().description("Home landMark");
