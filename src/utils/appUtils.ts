...
// Added company Location name in token Aashiq - 2/9/2020
	...
	if (params.companyId)
		userObject.companyId = params.companyId;
	if (params.companyLocationName)
		userObject.companyLocationName = params.companyLocationName;
	...
	if (params.type)
		userObject.type = params.type;
	if (params.created)
		userObject.created = params.created;
	// if (params.userType)
	// 	userObject.userType = params.userType;
	if (params.employeeId)
		userObject.employeeId = params.employeeId;
	// if (params.driverId)
	// 	userObject.driverId = params.driverId;
	if (params.createdBy)
		userObject.createdBy = params.createdBy;
if (params.contactNo)
		userObject.contactNo = params.contactNo;
...
let addKeyValue = function (obj, key, data) {
	obj[key] = data;
};
let addToObject = function (obj, key, value, index) {
