...
let validateCompanyCode = Joi.object({
...
let validateCompanyId = Joi.object({
	companyId: fieldsValidator.companyId
}).unknown();
let validateSubscriptionId = Joi.object({
	subscriptionId: fieldsValidator.subscriptionId
}).unknown();
let validateSubscriptionName = Joi.object({
	name: fieldsValidator.name
}).unknown();
